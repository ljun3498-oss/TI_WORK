...
void EPWM_Init(void)
{
    ...
    EPWM_setSyncOutPulseMode(EPWM2_BASE, EPWM_SYNC_OUT_DISABLED);

    // 配置EPWM3
    EPWM_setTimeBasePeriod(EPWM3_BASE, TBPRD);
    EPWM_setTimeBaseCounter(EPWM3_BASE, 0);
    EPWM_setTimeBaseCounterMode(EPWM3_BASE, EPWM_COUNTER_MODE_UP_DOWN);
    EPWM_setSyncOutPulseMode(EPWM3_BASE, EPWM_SYNC_OUT_DISABLED);

    // 配置死区
    EPWM_setDeadBandCounterClock(EPWM1_BASE, EPWM_DB_COUNTER_CLOCK_FULL_CYCLE);
    EPWM_setDeadBandDelayMode(EPWM1_BASE, EPWM_DB_REDUCED_HIGH);
    ...
    EPWM_setDeadBandDelayMode(EPWM2_BASE, EPWM_DB_REDUCED_HIGH);
    ...
    EPWM_setDeadBandDelayMode(EPWM3_BASE, EPWM_DB_REDUCED_HIGH);
    ...
    EPWM_setOutputEnable(EPWM1_BASE, EPWM_OUTPUT_A, EPWM_OUTPUT_ENABLE);  // 启用A相下管

    EPWM_setOutputEnable(EPWM2_BASE, EPWM_OUTPUT_B, EPWM_OUTPUT_DISABLE);
    EPWM_setOutputEnable(EPWM2_BASE, EPWM_OUTPUT_A, EPWM_OUTPUT_ENABLE);

    EPWM_setOutputEnable(EPWM3_BASE, EPWM_OUTPUT_B, EPWM_OUTPUT_DISABLE);
    EPWM_setOutputEnable(EPWM3_BASE, EPWM_OUTPUT_A, EPWM_OUTPUT_ENABLE);
